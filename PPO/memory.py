...
class Memory:
    ...
    def sample(self, mini_batch_idx):
        ...
        # return samples
        return (
            states[mini_batch_idx],
            actions[mini_batch_idx],
            log_probs[mini_batch_idx],
            discounted_returns[mini_batch_idx],
            advantages[mini_batch_idx],
            values[mini_batch_idx]
        )
    ...
    def get_mini_batch_idxs(self, mini_batch_size):
        ...
        return [
            idxs[start:start + mini_batch_size]
            for start in np.arange(0, self.size * self.num_envs, mini_batch_size)
        ]
